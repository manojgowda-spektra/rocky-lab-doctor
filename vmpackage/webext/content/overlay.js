  ...
  function guide(element, text, meta) {
    ...
    if (rk) {
      ...
      try {
        ...
        // points; it never clicks (see the ghost cursor block below).
        window.LabPilotRocky.guide(element, text || "Do this step", meta, function () { glow.style.display = "block"; ghostFly(element); });
